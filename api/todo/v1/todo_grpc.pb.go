...
func (c *todoClient) CreateTodo(ctx context.Context, in *CreateTodoRequest, opts ...grpc.CallOption) (*CreateTodoReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.todo.v1.Todo/CreateTodo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoClient) UpdateTodo(ctx context.Context, in *UpdateTodoRequest, opts ...grpc.CallOption) (*common.UpdateResp, error) {
	...
	err := c.cc.Invoke(ctx, "/api.todo.v1.Todo/UpdateTodo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoClient) DeleteTodo(ctx context.Context, in *common.IDReq, opts ...grpc.CallOption) (*common.UpdateResp, error) {
	out := new(common.UpdateResp)
	err := c.cc.Invoke(ctx, "/api.todo.v1.Todo/DeleteTodo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoClient) GetTodo(ctx context.Context, in *common.IDReq, opts ...grpc.CallOption) (*GetTodoReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.todo.v1.Todo/GetTodo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoClient) ListTodo(ctx context.Context, in *ListTodoRequest, opts ...grpc.CallOption) (*ListTodoReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.todo.v1.Todo/ListTodo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Todo_CreateTodo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.todo.v1.Todo/CreateTodo",
	}
...
func _Todo_UpdateTodo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.todo.v1.Todo/UpdateTodo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Todo_DeleteTodo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.todo.v1.Todo/DeleteTodo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Todo_GetTodo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.todo.v1.Todo/GetTodo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Todo_ListTodo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.todo.v1.Todo/ListTodo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
