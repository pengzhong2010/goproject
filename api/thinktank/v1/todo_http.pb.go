...
const OperationTodoCreateTodo = "/api.thinktank.v1.Todo/CreateTodo"
const OperationTodoDeleteTodo = "/api.thinktank.v1.Todo/DeleteTodo"
const OperationTodoGetTodo = "/api.thinktank.v1.Todo/GetTodo"
const OperationTodoListTodo = "/api.thinktank.v1.Todo/ListTodo"
const OperationTodoUpdateTodo = "/api.thinktank.v1.Todo/UpdateTodo"
...
func _Todo_DeleteTodo0_HTTP_Handler(srv TodoHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.DeleteTodo(ctx, req.(*IDReq))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
func _Todo_GetTodo0_HTTP_Handler(srv TodoHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetTodo(ctx, req.(*IDReq))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
type TodoHTTPClient interface {
	CreateTodo(ctx context.Context, req *CreateTodoRequest, opts ...http.CallOption) (rsp *UpdateResp, err error)
	DeleteTodo(ctx context.Context, req *IDReq, opts ...http.CallOption) (rsp *UpdateResp, err error)
	GetTodo(ctx context.Context, req *IDReq, opts ...http.CallOption) (rsp *GetTodoReply, err error)
	ListTodo(ctx context.Context, req *ListTodoRequest, opts ...http.CallOption) (rsp *ListTodoReply, err error)
	UpdateTodo(ctx context.Context, req *UpdateTodoRequest, opts ...http.CallOption) (rsp *UpdateResp, err error)
}
...
func (c *TodoHTTPClientImpl) CreateTodo(ctx context.Context, in *CreateTodoRequest, opts ...http.CallOption) (*UpdateResp, error) {
	var out UpdateResp
	pattern := "/todo/create"
...
func (c *TodoHTTPClientImpl) DeleteTodo(ctx context.Context, in *IDReq, opts ...http.CallOption) (*UpdateResp, error) {
	var out UpdateResp
	pattern := "/todo/delete"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *TodoHTTPClientImpl) GetTodo(ctx context.Context, in *IDReq, opts ...http.CallOption) (*GetTodoReply, error) {
...
func (c *TodoHTTPClientImpl) UpdateTodo(ctx context.Context, in *UpdateTodoRequest, opts ...http.CallOption) (*UpdateResp, error) {
	var out UpdateResp
	pattern := "/todo/update"
	path := binding.EncodeURL(pattern, in, false)
