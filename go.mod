...
require (
	...
	github.com/go-kratos/kratos/contrib/registry/nacos/v2 v2.0.0-20220921033151-2d325fd38684
...
replace github.com/go-kratos/kratos/v2 => github.com/go-kratos/kratos/v2 v2.5.0
